      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-px bg-border rounded-lg overflow-hidden mb-6 border border-border">
          {[
            ...
            { label: "Entries", value: fmt(entries.length), icon: Trophy },
        ...
        <Card className="p-5 mb-6 overflow-hidden">
          ...
          <div className="mt-3 text-[10px] text-muted-foreground">Score = shares×3 + comments×2 + likes×1 + views×1, best single post per contestant.</div>
        </Card>
