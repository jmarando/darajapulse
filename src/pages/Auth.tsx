        ...
        <Card className="p-6 shadow-elegant">
          {mode === "forgot" ? (
            <form onSubmit={forgot} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-primary" disabled={busy}>{busy ? "…" : "Send reset link"}</Button>
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground text-center mt-6 pt-4 border-t">
                No account? Daraja Pulse is invite-only — please contact your agency admin to be added.
              </p>
            </div>
          )}
        </Card>
