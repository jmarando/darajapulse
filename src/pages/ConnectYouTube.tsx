  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-paper p-6">
      <Card className="max-w-md w-full p-8 text-center">
        ...
        <h1 className="font-display text-3xl mt-4">Connect YouTube</h1>
        <p className="text-muted-foreground mt-3">
          {name ? `Hi ${name.split(" ")[0]} — ` : ""}YouTube integration is coming soon. Check back shortly to link your channel.
        </p>
      </Card>
    </div>
  );
